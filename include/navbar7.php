...
<nav class="navbar navbar-dark bg-dark fixed-top navbar-expand-lg">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link btn btn-secondary btn-font-white btn-color-special" href="../">Acceuil</a>
      </li>&nbsp;&nbsp;
      <li class="nav-item">
      ...
      &nbsp;&nbsp;
      <li class="nav-item">
        <a class="nav-link btn btn-secondary btn-font-white btn-font-white btn-color-special" href="../profil"><i class="fas fa-2x fa-user"></i></a>
      </li>&nbsp;&nbsp;
      <li class="nav-item">
