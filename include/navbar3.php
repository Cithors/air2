...
<nav class="navbar navbar-dark bg-dark fixed-top navbar-expand-lg">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link btn btn-secondary btn-font-white btn-color-special" href="index.php">Accueil</a>
      </li>
      &nbsp;&nbsp;
      <li class="nav-item">
        <a class="nav-link btn btn-info" href="inscription.php">Inscription</a>
      </li>
    </ul>
    </div>
     </div>
